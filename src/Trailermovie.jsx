          ...
          <div className="slides">
            <div className="trailerCard">
              ...
              <a
                ...
                href="https://www.youtube.com/watch?v=6L6XqWoS8tw"
                target="_blank"
                rel="noreferrer"
              >
                Watch on YouTube
            ...
            <div className="trailerCard">
              ...
              <a
                className="trailerLink"
                href="https://www.youtube.com/watch?v=fJaAYcERf3Y"
                target="_blank"
                rel="noreferrer"
              >
                Watch on YouTube
            ...
            <div className="trailerCard">
              ...
              <a
                className="trailerLink"
                href="https://www.youtube.com/watch?v=ISORfez27og"
                target="_blank"
                rel="noreferrer"
              >
                Watch on YouTube
            ...
            <div className="trailerCard">
              ...
              <a
                className="trailerLink"
                href="https://www.youtube.com/watch?v=JpVl_-1YgIo"
                target="_blank"
                rel="noreferrer"
              >
                Watch on YouTube
            ...
            <div className="trailerCard">
              ...
              <a
                className="trailerLink"
                href="https://www.youtube.com/watch?v=w8EDX5KqFLg"
                target="_blank"
                rel="noreferrer"
              >
                Watch on YouTube
